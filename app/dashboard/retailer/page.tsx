...
const menuItems = [
  { label: "Dashboard", href: "/dashboard/retailer" },
  { label: "Product Receipts", href: "/dashboard/retailer/receipts" },
]

export default function RetailerDashboard() {
  return (
    <DashboardLayout role="retailer" title="Reshboard" menuItems={menuItems}>
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-bold mb-4">Add Sale Info</h2>
